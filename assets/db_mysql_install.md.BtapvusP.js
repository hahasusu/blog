import{_ as s,c as n,o as a,a4 as l}from"./chunks/framework.GYzjcnJh.js";const u=JSON.parse('{"title":"安装","description":"","frontmatter":{"title":"安装"},"headers":[],"relativePath":"db/mysql/install.md","filePath":"backend/db/mysql/install.md"}'),p={name:"db/mysql/install.md"},e=l(`<h2 id="一-yum-安装" tabindex="-1">一 yum 安装 <a class="header-anchor" href="#一-yum-安装" aria-label="Permalink to &quot;一 yum 安装&quot;">​</a></h2><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#E2931D;">yum</span><span style="color:#91B859;"> install</span><span style="color:#91B859;"> -y</span><span style="color:#91B859;"> mysql-server</span></span>
...
<span class="line"><span style="color:#90A4AE;font-style:italic;"># 运行安全性脚本</span></span>
<span class="line"><span style="color:#E2931D;">mysql_secure_installation</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h2 id="二-二进制包安装" tabindex="-1">二 二进制包安装 <a class="header-anchor" href="#二-二进制包安装" aria-label="Permalink to &quot;二 二进制包安装&quot;">​</a></h2><div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki material-theme-lighter vp-code" tabindex="0"><code><span class="line"><span style="color:#90A4AE;font-style:italic;">#!/bin/bash</span></span>
<span class="line"></span>
